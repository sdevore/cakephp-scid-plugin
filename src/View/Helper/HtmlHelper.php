...
MAP;
        ...
        /**
         * @param null|array|string $brand
         *
         * @return array
         */
        public function breadcrumbOptions($brand = NULL) {
...
ENABLETOOLTIP;
         ...
         * @return void
         */
        public function addVueJs($options = NULL) {
            $addVue = FALSE;
            if (empty($options)) {
                $addVue = TRUE;
            }
            ...
            if ($addVue) {
                ...
                $this->script($vue, ['block' => self::SCRIPT_TOP]);
            }
        }
         ...
         * @return void
         */
        function toggleHeadingIcon($id, $up = "fa-chevron-up", $down = "fa-chevron-down") {
