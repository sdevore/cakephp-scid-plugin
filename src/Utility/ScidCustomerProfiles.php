...
class ScidCustomerPaymentProfiles
{
    ...
    private $_errors = [];
    /**
     * @param   \Cake\Datasource\EntityInterface|\App\Model\Entity\Member   $member
     * @param null|\Cake\Datasource\EntityInterface $payment
     *
     * @return mixed
     */
        public function create($member, $payment = null) {
            if (empty($member->auth_net_customer_id)) {
                $this->_errors['member'][] = ['message'=>$customerExitst]
            }
